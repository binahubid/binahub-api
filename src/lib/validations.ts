...
export const AssessmentSchema = z.object({
  ...
  timeline: z.enum(['unknown', '0_3', '3_6', '6_12', '12_plus']).optional(),
  budgetStatus: z.enum(['unknown', 'discussion', 'range_known', 'allocated']).optional(),
  sponsorStatus: z.enum(['unknown', 'champion', 'sponsor_confirmed', 'decision_maker']).optional(),
  nextStepIntent: z.enum(['explore', 'result_review', 'consultation', 'proposal']).optional(),
