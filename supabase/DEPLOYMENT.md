...
2. Terapkan migration `binahub-api/supabase/migrations/0005` sampai `0033` sebagai raw SQL secara leksikografis, bukan sebagai riwayat kedua `db push`.
